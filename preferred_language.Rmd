...
packages <- c("zoo", "data.table", "dplyr", "lubridate", "lme4", "sjPlot")
...
rass_hosp_clean <- merge(hosp_clean_time, pat_assess_rass_clean, by = "hospitalization_id", all.x = TRUE)


# STEP 4: Merge with Timeline to give additional data points for filling
