...
respiratory_support <- as.data.table(read_data(paste0(data_dir, "clif_respiratory_support", file_type), select = c("hospitalization_id", "recorded_dttm", "device_category", "tracheostomy")))
hospitalization <- as.data.table(read_data(paste0(data_dir, "clif_hospitalization", file_type), select = c("patient_id", "hospitalization_id", "admission_dttm", "discharge_dttm", "age_at_admission", "discharge_category")))
hospitalization <- unique(hospitalization, by = "hospitalization_id")
patient <- as.data.table(read_data(paste0(data_dir,"clif_patient", file_type), select = c("patient_id", "death_dttm")))
