...
intermediate_dir <-  file.path(here(), "sedation_language_project", "intermediate_data")  # Define output_dir based on data_dir
output_dir <- file.path(here(), "sedation_language_project", "final_data")
